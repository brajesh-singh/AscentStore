 ...
 */
package com.pwc.demo.cockpits.setup;
...
import com.pwc.demo.cockpits.constants.AscentCockpitsConstants;
 ...
 */
@SystemSetup(extension = AscentCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AscentCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AscentCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AscentCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/ascentcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
