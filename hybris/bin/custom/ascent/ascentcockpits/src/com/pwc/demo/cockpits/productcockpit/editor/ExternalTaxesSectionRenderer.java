 ...
 */
package com.pwc.demo.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("ascentcockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("ascentcockpits.product.externalTaxes"));
