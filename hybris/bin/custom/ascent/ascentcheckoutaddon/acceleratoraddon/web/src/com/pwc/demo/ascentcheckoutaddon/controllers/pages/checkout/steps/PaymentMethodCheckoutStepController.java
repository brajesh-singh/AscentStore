	...
	public String enterStep(final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		if (CheckoutPciOptionEnum.HOP.equals(subscriptionPciOption))
		{
			...
			try
			{
				...
				return AscentcheckoutaddonControllerConstants.Views.Pages.MultiStepCheckout.HostedOrderPostPage;
			}
		...
		else if (CheckoutPciOptionEnum.SOP.equals(subscriptionPciOption))
		{
			...
			try
			{
				...
				return AscentcheckoutaddonControllerConstants.Views.Pages.MultiStepCheckout.SilentOrderPostPage;
			}
			catch (final Exception e)
			{
				LOGGER.error("Failed to build beginCreateSubscription request", e);
		...
		return AscentcheckoutaddonControllerConstants.Views.Pages.MultiStepCheckout.AddPaymentMethodPage;
	}
