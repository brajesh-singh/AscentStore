 ...
 */
package com.pwc.demo.test.setup;
...
import com.pwc.demo.test.constants.AscentTestConstants;
import com.pwc.demo.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AscentTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ascenttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ascenttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/ascenttest/import/cstickets.impex");
			...
			importImpexFile(context, "/ascenttest/import/csquotes.impex");
		}
	}
}
