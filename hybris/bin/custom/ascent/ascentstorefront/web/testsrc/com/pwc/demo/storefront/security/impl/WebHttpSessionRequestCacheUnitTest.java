...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ascentstorefront/electronics/en",
						"https://electronics.local:9002/ascentstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ascentstorefront/electronics/en",
						"https://electronics.local:9002/ascentstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ascentstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ascentstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ascentstorefront/electronics/en",
						"https://electronics.local:9002/ascentstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ascentstorefront",
						"https://electronics.local:9002/ascentstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ascentstorefront",
						"https://electronics.local:9002/ascentstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ascentstorefront/electronics/en",
						"https://electronics.local:9002/ascentstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
