...
<c:set value="${component.styleClass} ${dropDownLayout}"
	var="bannerClasses" />
<c:url value="${component.link.url}" var="navigationNodePath"/>
...
<li><a href="${navigationNodePath}">${component.name}</a> <%-- <cms:component
		component="${component.link}" evaluateRestriction="true"
