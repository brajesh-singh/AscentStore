 ...
 */
package com.pwc.demo.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AscentFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AscentFulfilmentProcessConstants.PARENT_PROCESS);
