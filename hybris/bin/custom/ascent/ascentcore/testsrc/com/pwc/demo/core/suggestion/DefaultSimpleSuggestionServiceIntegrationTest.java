 ...
 */
package com.pwc.demo.core.suggestion;
...
import com.pwc.demo.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/ascentcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
